...
public class WolfRenderer extends MobRenderer<WolfEntity, WolfModel<WolfEntity>> {
    ...
    protected float getBob(WolfEntity p_116528_, float p_116529_) {
        return p_116528_.getTailAngle();
    }

    public void render(WolfEntity p_116531_, float p_116532_, float p_116533_, PoseStack p_116534_, MultiBufferSource p_116535_, int p_116536_) {
        if (p_116531_.isWet()) {
    ...
    public ResourceLocation getTextureLocation(WolfEntity p_116526_) {
        if (p_116526_.isTame()) {
