...
@OnlyIn(Dist.CLIENT)
public class WolfCollarLayer extends RenderLayer<WolfEntity, WolfModel<WolfEntity>> {
    private static final ResourceLocation WOLF_COLLAR_LOCATION = new ResourceLocation("textures/entity/wolf/wolf_collar.png");

    public WolfCollarLayer(RenderLayerParent<WolfEntity, WolfModel<WolfEntity>> p_117707_) {
        super(p_117707_);
    }
