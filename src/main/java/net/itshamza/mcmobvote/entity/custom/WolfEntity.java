...
public class WolfEntity extends Wolf implements NeutralMob {
    private static final EntityDataAccessor<Boolean> DATA_INTERESTED_ID = SynchedEntityData.defineId(WolfEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_COLLAR_COLOR = SynchedEntityData.defineId(WolfEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(WolfEntity.class, EntityDataSerializers.INT);
    ...
    private static final EntityDataAccessor<Boolean> ARMORED =
            SynchedEntityData.defineId(WolfEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public WolfEntity(EntityType<? extends WolfEntity> p_30369_, Level p_30370_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new WolfEntity.WolfEntityPanicGoal(1.5D));
        this.goalSelector.addGoal(2, new SitWhenOrderedToGoal(this));
        this.goalSelector.addGoal(3, new WolfEntity.WolfEntityAvoidEntityGoal<>(this, Llama.class, 24.0F, 1.5D, 1.5D));
    ...
    public InteractionResult mobInteract(Player p_30412_, InteractionHand p_30413_) {
        ...
        if (this.level.isClientSide) {
            ...
            if (this.isTame()) {
                ...
                if (itemstack.getItem() == ModItems.WOLF_ARMOR.get()) {
                    if (!p_30412_.getAbilities().instabuild) {
                        itemstack.shrink(1);
                    }

                    double ARMOR_ATTRIBUTE = this.getAttribute(Attributes.ARMOR).getBaseValue();
                    double ARMOR_LEVEL = 10;
                    double NEW_ARMOR_LEVEL = ARMOR_ATTRIBUTE += ARMOR_LEVEL;
                    this.getAttribute(Attributes.ARMOR).setBaseValue(NEW_ARMOR_LEVEL);
                    setArmored(true);
                    return InteractionResult.SUCCESS;
                }
    ...
    public Item isArmor(ItemStack p_30440_) {
        Item item = p_30440_.getItem();
        return item = ModItems.WOLF_ARMOR.get();
    }
    ...
    public WolfEntity getBreedOffspring(ServerLevel p_149088_, AgeableMob p_149089_) {
        WolfEntity WolfEntity = ModEntityCreator.WOLF.get().create(p_149088_);
    ...
    public boolean canMate(Animal p_30392_) {
        if (p_30392_ == this) {
            ...
            return false;
        } else if (!(p_30392_ instanceof WolfEntity)) {
            return false;
        } else {
            WolfEntity WolfEntity = (WolfEntity)p_30392_;
    ...
    public boolean wantsToAttack(LivingEntity p_30389_, LivingEntity p_30390_) {
        if (!(p_30389_ instanceof Creeper) && !(p_30389_ instanceof Ghast)) {
            if (p_30389_ instanceof WolfEntity) {
                WolfEntity WolfEntity = (WolfEntity)p_30389_;
                return !WolfEntity.isTame() || WolfEntity.getOwner() != p_30390_;
    ...
    public static boolean checkWolfEntitySpawnRules(EntityType<WolfEntity> p_218292_, LevelAccessor p_218293_, MobSpawnType p_218294_, BlockPos p_218295_, RandomSource p_218296_) {
    ...
    class WolfEntityAvoidEntityGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        private final WolfEntity WolfEntity;

        public WolfEntityAvoidEntityGoal(WolfEntity p_30454_, Class<T> p_30455_, float p_30456_, double p_30457_, double p_30458_) {
            super(p_30454_, p_30455_, p_30456_, p_30457_, p_30458_);
            this.WolfEntity = p_30454_;
        }

        public boolean canUse() {
            if (super.canUse() && this.toAvoid instanceof Llama) {
                return !this.WolfEntity.isTame() && this.avoidLlama((Llama)this.toAvoid);
            } else {
                return false;
            }
        }
        ...
        private boolean avoidLlama(Llama p_30461_) {
            return p_30461_.getStrength() >= WolfEntity.this.random.nextInt(5);
        }
    ...
    class WolfEntityPanicGoal extends PanicGoal {
        public WolfEntityPanicGoal(double p_203124_) {
            super(WolfEntity.this, p_203124_);
        }
